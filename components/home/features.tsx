          ...
          <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="overflow-hidden p-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Kami membantu Anda membuat website yang modular dan mudah
                dikelola.
              </p>
            ...
            <Card className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Kami membantu Anda membuat website yang responsif dan mudah
                diakses di semua device.
              </p>
            ...
            <Card className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                Kami membantu Anda membuat website yang SEO friendly dan mudah
